...
function moveup(n){
    let V = document.querySelector(".film"+n+"-naam").innerHTML;
    if((n!=1)){
    document.querySelector(".film"+n+"-naam").innerHTML=document.querySelector(".film"+(n-1)+"-naam").innerHTML;
    document.querySelector(".film"+(n-1)+"-naam").innerHTML=V;    
    }
}
function movedown(n){
    let V = document.querySelector(".film"+n+"-naam").innerHTML;
